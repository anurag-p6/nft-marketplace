        ...
        <section className="mt-16">
          ...
          {loading ? (
            ...
            <div className="text-center py-16 animate-fade-in">
              ...
              <Link href="/create">
                <button className="mt-4 px-6 py-2 bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-lg font-semibold hover:from-purple-500 hover:to-pink-500 transition-all duration-300 shadow-lg hover:shadow-purple-300 transform hover:scale-105">
                  Create NFT
                </button>
              </Link>
            </div>
